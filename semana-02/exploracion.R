...
install.packages(c("gmodels", "ggplot2", "vcd","agricolae","tidyverse", "Hmisc", "psych", "fBasics", "treemap", "ggmap", "mosaic"),
...
##___________________________________________________________________________________
## Ejercicio: Analice la distribuci?n del salario de los clientes
##___________________________________________________________________________________

#------------------------------------------------------------------#
#  f) An?lisis descriptivo                                         #
#------------------------------------------------------------------#
...
# Definir funciones con medidas estad?sticas
...
# Funci?n para calcular asimetria (Pearson)
A3 <- function(x){
...
# Funciones de resumen de datos disponibles en otras librer?as
...
##___________________________________________________________________________________
## Ejercicio: Realice el an?lisis descriptivo para el salario de los clientes
##___________________________________________________________________________________

#------------------------------------------------------------------#
#  g) An?lisis descriptivo comparativo                             #
#------------------------------------------------------------------#
...
#Usando tidyverse
credit %>% filter(!is.na(DM)) %>% group_by(Y) %>%
DMark %>% group_by(Ecivil) %>%
...
# An?lisis comparativo usando visualizaci?n de datos
# ---------------------------------------------------
...
# A?adir una columna con el feedback negativo
